...
class RealEstatePurchaseSimulator:
        ...
        def actual_decorator(function):
            ...
            def wrapper(self, *args, **kwargs):
                try:
                    ...
                    raise RealEstateError from exc
    ...
    def find_house_size(self, surface_rate_price, notary_rate, contribution, annual_payment, interest_rate, target_years, right_value, left_value):
        """Find house size.
