...
class SimulationMode(Enum):
    """Loan duration, House surface, Contribution, Monthly payment, Interest rate mode possible"""
    LOAN_DURATION, HOUSE_SURFACE, CONTRIBUTION, MONTHLY_PAYMENT, INTEREST_RATE = range(5)
...
class RealEstatePurchaseSimulator:
    ...
    DICT_MAX_VALUE = {"MAX_HOUSE_SIZE": "_find_house_size", "MAX_CONTRIBUTION": "_find_contribution",
                      "MAX_MONTHLY_PAYMENT": "_find_monthly_payment", "MAX_INTEREST_RATE": "_find_interest_rate"}
    ...
    def __raise_payment_error(self, expansive):
    ...
    def __keep_loan_interest_statistic(self, loan, interest, cumulated_loan, cumulated_interest):
    ...
    def _find_years(self, loan, interest_rate, annual_payment):
        """ Find years of loan.
        ...
        if interest_rate * remaining_loan >= annual_payment:
            self.__raise_payment_error(True)
        # Customer can not ask for loan
        if remaining_loan <= 0:
            self.__raise_payment_error(False)
        ...
        while remaining_loan > (annual_payment - interest_rate * remaining_loan):
            ...
            self.__keep_loan_interest_statistic(loan_refund, interest_refund,
    ...
    def _find_house_size(self, surface_rate_price, notary_rate, contribution, annual_payment, interest_rate,
        ...
        while abs(self.year - target_years) > self.EPSILON and right_value - left_value > self.EPSILON:
            ...
            left_value, right_value = self.__update_left_right_value(loan, interest_rate, annual_payment,
    ...
    def _find_contribution(self, house_price, notary_rate, annual_payment, interest_rate, target_years,
    ...
    def _find_monthly_payment(self, loan, interest_rate, target_years, right_value, left_value):
        """ Find annual payment.
        ...
        while abs(self.year - target_years) > self.EPSILON and right_value - left_value > self.EPSILON:
            ...
            left_value, right_value = self.__update_left_right_value(loan, interest_rate, current_annual_payment,
    ...
    def _find_interest_rate(self, loan, annual_payment, target_years, right_value, left_value):
        """ Find interest rate.
        ...
        while abs(self.year - target_years) > self.EPSILON and right_value - left_value > self.EPSILON:
            ...
            left_value, right_value = self.__update_left_right_value(loan, current_interest_rate, annual_payment,
    ...
    def __update_left_right_value(self, loan, interest_rate, annual_payment,
        ...
        try:
            self._find_years(loan, interest_rate, annual_payment)  # Update self.year
        except Exception:
    ...
    def run(self, *args, **kwargs):
        match MODE:
            case SimulationMode.LOAN_DURATION:
                self._find_years(*args, **kwargs)
            case SimulationMode.HOUSE_SURFACE:
                self._find_house_size(*args, **kwargs)
            case SimulationMode.CONTRIBUTION:
                self._find_contribution(*args, **kwargs)
            case SimulationMode.MONTHLY_PAYMENT:
                self._find_monthly_payment(*args, **kwargs)
            case SimulationMode.INTEREST_RATE:
                self._find_interest_rate(*args, **kwargs)


# Default mode is years finding
MODE = SimulationMode.LOAN_DURATION
...
if __name__ == "__main__":
    ...
    # Mode can be LOAN_DURATION, HOUSE_SURFACE, CONTRIBUTION, MONTHLY_PAYMENT, INTEREST_RATE from SimulationMode class
    MODE = SimulationMode.INTEREST_RATE
    ...
    match MODE:
        case SimulationMode.LOAN_DURATION:
            ...
            simulation.run(LOAN, INTEREST_RATE, ANNUAL_PAYMENT)
        ...
        case SimulationMode.HOUSE_SURFACE:
            ...
            simulation.run(SURFACE_RATE_PRICE, NOTARY_COST_RATE, CONTRIBUTION,
        ...
        case SimulationMode.CONTRIBUTION:
            ...
            simulation.run(HOUSE_PRICE, NOTARY_COST_RATE, ANNUAL_PAYMENT, INTEREST_RATE, LOAN_YEARS)
        ...
        case SimulationMode.MONTHLY_PAYMENT:
            ...
            simulation.run(LOAN, INTEREST_RATE, LOAN_YEARS)
        ...
        case SimulationMode.INTEREST_RATE:
            ...
            simulation.run(LOAN, ANNUAL_PAYMENT, LOAN_YEARS)
